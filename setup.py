...
PUBLIC_SOURCE_PATHS = (
    ...
    "integrations/agents/embedded.py",
    ...
    "integrations/providers/openai_helpers.py",
    "integrations/providers/openai_models.py",
    "integrations/providers/openai_runtime.py",
...
setup(
    ...
    package_data={
        ...
        "atellagent_client.examples": ["config/*.yaml"],
    },
